...
export async function helpCommand() {
    ...
    console.log(chalk.gray('    /skills                List discovered skills'));
    console.log(chalk.gray('    /skill <name>          Activate a skill'));
    console.log(chalk.gray('    /skill clear           Clear active skill'));
    console.log(chalk.gray('    /skills recommend <task>  Recommend skills for a task'));
    console.log(chalk.gray('    /skills active         Show active skills'));
    console.log(chalk.gray('    /skills use <n1,n2>    Activate multiple skills'));
