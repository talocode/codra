import { VisualPlan, VisualPlanSection, FileImpact, VisualPlanDiagram } from './types.js';
import { getPlan } from '../plans/store.js';
import { getConfig } from '../config.js';
import { getActiveSkill } from '../skills/active.js';

export function createVisualPlanFromTask(task: string): VisualPlan {
...
export function createVisualPlanFromPlanId(planId: string): VisualPlan | null {
